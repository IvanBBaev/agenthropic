 ...
 * three workspace packages were unguarded. This one carries the TypeBox
 * schemas and security helpers every other package consumes: a pragma hiding
 * an untested schema branch here would silently weaken the contract of every
 * API route and every client that validates against it.
 *
