...
/**
 * The four structural spawn-edge join paths (parser-spec section 4). Served
 * verbatim as persisted - the observed-vs-inferred provenance distinction is
 * the honesty rule and must survive every hop to the UI.
 */
