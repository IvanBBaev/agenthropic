 ...
 * three workspace packages were unguarded. This one carries the fixture
 * builders and annotation readers: a defect hidden behind a pragma here does
 * not fail loudly, it silently weakens every downstream parser and ingest
 * test that consumes the fixture — the exact reason this package was pulled
 * into the coverage gate in the first place (see vitest.config.ts).
 *
